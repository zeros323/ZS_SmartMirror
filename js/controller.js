(function(angular) {
    ...
    function MirrorCtrl(
            ...
            MapService,
            CalendarService,
            //GoogleCalendarService,   // 적용 실패 google-calendar.js
            //TrafficService,
            SubwayService,
            YoutubeService,
...
//            $interval(refreshTrafficData, config.traffic.reload_interval * 60000);
            ...
            // 가족사진보여줘
            AnnyangService.addCommand(command.slideshowfamilyphoto,function() {
            	console.debug("family photo slide show...");
            	functionService.slideshowFamilyPhoto($scope);
